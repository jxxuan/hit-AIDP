...
class Model(torch.nn.Module):
    def __init__(self):
        ...
        # 卷积层
        self.conv1 = torch.nn.Conv2d(1, 32, kernel_size=(2, 2), stride=(1, 1))
        self.conv2 = torch.nn.Conv2d(32, 64, kernel_size=(2, 2), stride=(1, 1))
        ...
        # 全连接层
        self.fc1 = torch.nn.Linear(10816, 128)
...
def get_data():
    ...
    test_loader = DataLoader(test, batch_size=1000)  # 分割训练
